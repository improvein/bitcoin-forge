...
class CreateMultisigP2WSH extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(event) {
    ...
    try {
      ...
      const address = addressService.createMultisigP2WSH(publicKeysArr, requiredSigs);
...
export default CreateMultisigP2WSH;
