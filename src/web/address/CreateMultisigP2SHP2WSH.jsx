...
class CreateMultisigP2SHP2WSH extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(event) {
    ...
    try {
      ...
      const address = addressService.createMultisigP2SH_P2WSH(publicKeysArr, requiredSigs);
...
export default CreateMultisigP2SHP2WSH;
